...
<?php 
        ...
        saveStaff($staff_id, $staff_surname, $staff_name, $staff_patronymic, $staff_date_of_birth, $place_of_birth, $sex, $nationality, $home_address, $marital_status, $stay_abroad, $attitude_to_military_duty, $awards, $date_of_entry, $experience);
?>
